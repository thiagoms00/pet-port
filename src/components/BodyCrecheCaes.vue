...
export default {
  ...
  methods: {
    mudaPagina(location) {
      switch (location) {
        case "banho":
          ...
          break;
        case "creche":
          this.$router.push("/services/creche-caes");
          break;
        case "festa":
          this.$router.push("/services/festa-de-aniversario");
          break;
        case "hotelCaes":
          this.$router.push("/services/hotelzinho-caes");
          break;
        case "hotelGatos":
          this.$router.push("/services/hotelzinho-gatos");
          break;
        case "form":
    ...
    openWhatsApp() {
      ...
      const message =
        "Olá estou interessado nos serviços de Creche do Nosso Mundo Pet!"; // Replace with your desired message
...
<template>
  ...
  <v-container fluid class="pa-0 ma-0">
    <v-row class="img-row mx-auto mt-12 elevation-4">
      ...
      <v-divider
        v-if="!mobile"
        class="cover-divider border-opacity-50"
        :thickness="2"
        vertical
        color="#40469e"
      ></v-divider>
    ...
    <v-row class="data-row mx-auto pa-10 mt-7 elevation-4">
      <v-col :cols="leftCol" class="data-left">
        ...
        <p class="data-p">
          Traga seu cão para passar o dia conosco e se divertir com outros cães.
          A programação inclui atividades de enriquecimento ambienta, banho de
          piscina e outras atividades que proporcionam bem estar e integração.
          Todas as atividades são acompanhadas por um recreador. A adaptação é
          agendada e sem custo.
        </p>
      </v-col>
      ...
      <v-col :cols="rightCol" class="data-right">
        <div class="function-div call-div d-flex elevation-10">
          <v-icon
            icon="mdi-whatsapp mt-7"
            color="#fff"
            size="x-large"
            class="contact-icon"
          ></v-icon>
          <v-col
            class="text-contact ml-2"
    ...
    <v-container fluid class="fotos-container">
      <v-row
        class="prices-title-row outras-row align-center justify-center mt-5"
      >
        <h1 class="table-title outras-title">Outras Fotos</h1>
      </v-row>
      <v-row
        class="prices-title-row outras-row align-center justify-center mt-10"
      >
        <h1 class="table-title outras-title location-title">Santa tereza</h1>
      </v-row>
      <v-row
        class="prices-title-row align-center justify-center outras-imgs-row mt-5"
      >
        <div class="img-wrapper3">
          <v-img
            ...
            cover
            class="other-img"
            src="../assets/imgs/santa-tereza1.jfif"
          >
          </v-img>
        </div>
        ...
        <div class="img-wrapper3">
          <v-img
            ...
            cover
            class="other-img"
            src="../assets/imgs/santa-tereza2.jfif"
          >
          </v-img>
        </div>
      </v-row>
      <v-row
        class="prices-title-row outras-row align-center justify-center mt-5"
      >
        <h1 class="table-title outras-title location-title">Sagrada Família</h1>
      </v-row>
      <v-row
        class="prices-title-row align-center justify-center outras-imgs-row"
      >
        <div class="img-wrapper3">
          <v-img
            :width="620"
    ...
    <v-row class="prices-title-row diaria-row mx-auto pt-12 mt-12">
      <h1 class="table-title mx-auto">Diária</h1>
    </v-row>

    <v-row class="prices-first-row mx-auto pt-5 align-center justify-center">
      <div
        class="title-and-price d-flex flex-column align-center justify-center first-row"
      >
        <h3 class="table-sub">Diária avulsa</h3>
        <h1 class="table-price">R$62,00</h1>
      </div>
      <div class="custom-divider"></div>

      <div
        class="title-and-price d-flex flex-column align-center justify-center ml-8 first-row"
      >
        <h3 class="table-sub">
          Pacote de 4 diárias avulsas
          <span class="table-details">(30 dias para utilização)</span>
        </h3>
        <h1 class="table-price">R$235,00</h1>
      </div>
    </v-row>
    ...
    <v-row
      class="prices-first-row second-prices-row mx-auto pa-5 align-center justify-center"
    >
      <div
        class="title-and-price d-flex flex-column align-center justify-center"
      >
        <h3 class="table-sub">2 Vezes por semana</h3>
        <h1 class="table-price">R$415,00</h1>
      </div>
      <div v-if="!mobile" class="custom-divider"></div>

      <div
        class="title-and-price d-flex flex-column align-center justify-center ml-8"
      >
        <h3 class="table-sub">3 Vezes por semana</h3>
        <h1 class="table-price">R$575,00</h1>
      </div>
      <div v-if="!mobile" class="custom-divider"></div>

      <div
        class="title-and-price last-table d-flex flex-column align-center justify-center ml-8"
      >
        <h3 class="table-sub last-sub">4 vezes por semana</h3>
        <h1 class="table-price">R$699,00</h1>
      </div>
    </v-row>
    ...
    <v-container fluid class="other-container pa-5 ma-0">
      ...
      <v-row class="services-row align-center justify-center mt-12">
        <div
          class="img-card d-flex flex-column align-center justify-center elevation-2"
